...
module.start = function()
    ...
    hs.hotkey.bind(hyper, "C", function()
        ...
        boundApplication = hs.hotkey.bind(hyper, 'V', function () hs.application.launchOrFocus(appName) end)
    ...
    hs.hotkey.bind(hyper, 'N', function () arrowKey("DOWN") end)
    hs.hotkey.bind(hyper, 'P', function () arrowKey("UP") end)
