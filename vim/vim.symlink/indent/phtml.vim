...
setlocal indentexpr=GetPhtmlIndent()
"setlocal indentkeys+=0=,0),=EO
setlocal indentkeys+=0=,0),=EO,o,O,*<Return>,<>>,<bs>,{,}

" Only define the function once.
if exists("*GetPhtmlIndent")
	finish
endif

" Handle option(s)
if exists("phtml_noindent_switch")
	let b:phtml_noindent_switch=1
endif
...
function GetPhtmlIndent()
	...
	if exists("b:phtml_noindent_switch") " version 1 behavior, diy switch/case,etc
